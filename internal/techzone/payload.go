...
// variable so that any future upstream change to the "Reservation Name" platform record
...
// platformRecord is the "Reservation Name" platform object copied verbatim from
	...
	"regions": []map[string]any{
		{
			...
			"requestMethod": "template-example",
			"cloudAccount":  "ITZ",
			"geo":           "",
			"region":        "us-east-2",
			"datacenter":    "",
			...
			"pattern": map[string]any{
				"id":      "ccp-gitops/template-example/itz",
...
var (
	...
	fixedIUI            = "2700013C3V"
	fixedTemplate       = "template-example"
